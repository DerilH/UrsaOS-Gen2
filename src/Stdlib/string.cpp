...
const char* to_string(uint8_t num) {return to_stringT<uint8_t>(num);}
const char* to_string(uint16_t num){return to_stringT<uint16_t>(num);}
const char* to_string(uint32_t num){return to_stringT<uint32_t>(num);}
const char* to_string(uint64_t num){return to_stringT<uint64_t>(num);}
const char* to_string(int8_t num)  {return to_stringT<int8_t>(num);}
const char* to_string(int16_t num) {return to_stringT<int16_t>(num);}
const char* to_string(int32_t num) {return to_stringT<int32_t>(num);}
const char* to_string(int64_t num) {return to_stringT<int64_t>(num);}
